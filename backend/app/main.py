...
from app.routes import health, analyze, document, rights, schemes, action_plan, draft, history, interview, lawyers
...
app.include_router(lawyers.router, prefix="/api", tags=["Lawyers Directory"])
