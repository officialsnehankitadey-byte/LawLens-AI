...
class FallbackProvider(AIProvider):
    ...
    async def analyze_problem(self, request: ProblemRequest) -> SituationAnalysisResponse:
        ...
        if cat_key == "criminal":
            ...
            reassurance = "Take a deep breath ΓÇö you are entitled to full protection under Indian law (Article 22 & BNSS). Police cannot arbitrarily harass or arrest anyone without following mandatory legal safeguards. Follow the steps below calmly."
            ...
            reassurance = "Don't panic ΓÇö unauthorized bank transactions are strictly protected under RBI rules. If you report quickly, banks can freeze the scammer's account and you are entitled to full zero-liability reimbursement."
            ...
            steps = [
                ActionStep(
                    ...
                    required_documents=["RTI Application Draft", "Identity Proof", "Γé╣10 Application Fee (IPO / Online)"]
                ),
                ActionStep(
                    step_number=2,
                    title="Submit Application on rtionline.gov.in or via Speed Post with Γé╣10 Fee",
                    simple_summary="File on the central/state portal or post to the Public Information Officer (PIO).",
                    description="Submit online or mail your signed application with a Γé╣10 Postal Order to the Public Information Officer (PIO) of the department.",
                    action_type="online_portal",
            ...
            rights = [
                RightOrSchemeItem(
                    topic="Consumer Protection Act, 2019 ΓÇö Right to Redressal & Refund",
